...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		barrier = new FlxSprite().loadGraphic(Paths.image('barriers/menuSide'));
	...
	flipps.y = 1000;
		...
		else if (curSelected == 6)
		{
			...
			{
				bg.loadGraphic('assets/images/splashes/kapowbg.png');
				flipps.loadGraphic('assets/images/splashes/kapowt.png');
				FlxTween.tween(flipps,{y: 0}, 0.25 ,{ease: FlxEase.expoInOut});
			}	
		else if (curSelected == 8)
			{
				bg.loadGraphic('assets/images/splashes/minusbg.png');
				flipps.loadGraphic('assets/images/splashes/minust.png');
				FlxTween.tween(flipps,{y: 0}, 0.25 ,{ease: FlxEase.expoInOut});
			}
