...
{
	public static var flippyVersion:String = '3.0'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "VS Flippy Flipped Out v" + flippyVersion, 12);
